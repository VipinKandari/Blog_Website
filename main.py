...
def register():
    ...
    if form.validate_on_submit():
        ...
        if not result:
            ...
            flash(message="You have already signed up with that email. Try logging in instead ")
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if not current_user.is_authenticated:
            flash(message="You need to Sign up your account before adding a comment on a post")
            return redirect(url_for('login'))
